...
void atoms(){
   ...
   if(config::internal::mode != legacy && vmpi::my_rank == 0){
      write_meta(real_time, sim::temperature, sim::actual_H_vector[0], sim::actual_H_vector[1], sim::actual_H_vector[2], sim::actual_H_field, magnetisation[0], magnetisation[1], magnetisation[2]);
   }

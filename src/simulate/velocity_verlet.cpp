  ...
  ///  std::cout << lattice_cell_coordinate[0][0][0] << std::endl;
    ...
    //  std::cout << size << std::endl;
      ...
      for(int i = 1; i < size; i++) {
        const int electron = cell_integration_lists.at(int_cell).at(i);
        ...
        electron_nearest_electron_list.at(e).at(ee_dos_count) = electron;
        ee_dos_count++;
       //  std::cout << e << ", " << i << ", " << length << std::endl;
        ...
        electron_ee_scattering_list.at(e).at(ee_scattering_list) = electron;
    ...
    for(int e = 1; e < size; e++) {
      ...
      for(int a = 2; a < scattering_size; a++) {
        ...
        if(equilibrium_step) {  
          ...
          //     e_occupation = int(round((ee_dos_hist.at(electron).at(hist-1)+ee_dos_hist.at(electron).at(hist)+ee_dos_hist.at(electron).at(hist+1))/3));
          //   } else if (hist == 10){
          //     e_dos = int(round(2*DoS_width*FD_width+0.25*DoS_width*FD_width));
          //     e_occupation = int(round((DoS_width*FD_width*ee_dos_hist.at(electron).at(hist-1)+DoS_width*FD_width*ee_dos_hist.at(electron).at(hist)+0.25*DoS_width*FD_width*ee_dos_hist.at(electron).at(hist+1))/avg_dos));
          //   } else {
          //     e_dos = int(round(DoS_width*FD_width+0.5*DoS_width*FD_width));
          //     e_occupation = int(round((DoS_width*FD_width*ee_dos_hist.at(electron).at(hist-1)+0.25*DoS_width*FD_width*ee_dos_hist.at(electron).at(hist)+0.25*DoS_width*FD_width*ee_dos_hist.at(electron).at(hist+1))/avg_dos));
          //   }
          ...
          //     d_e_occupation = int(round((ee_dos_hist.at(electron).at(hist-1)+ee_dos_hist.at(electron).at(hist)+ee_dos_hist.at(electron).at(hist+1))/3));
          //   } else if (hist == 10){
          //     d_e_dos = int(round(2*DoS_width*FD_width+0.25*DoS_width*FD_width));
          //     d_e_occupation = int(round((DoS_width*FD_width*ee_dos_hist.at(electron).at(hist-1)+DoS_width*FD_width*ee_dos_hist.at(electron).at(hist)+0.25*DoS_width*FD_width*ee_dos_hist.at(electron).at(hist+1))/avg_dos));
          //   } else {
          //     d_e_dos = int(round(DoS_width*FD_width+0.5*DoS_width*FD_width));
          //     d_e_occupation = int(round((DoS_width*FD_width*ee_dos_hist.at(electron).at(hist-1)+0.25*DoS_width*FD_width*ee_dos_hist.at(electron).at(hist)+0.25*DoS_width*FD_width*ee_dos_hist.at(electron).at(hist+1))/avg_dos));
          //   }
          //   if(e_dos < (15.0/195.0) || d_e_dos < (15.0/195)) continue;
            if(e_energy - deltaE < transport_cutoff) {
              ...
              for (int e = 1; e < electron_nearest_electron_list.at(electron)[0]; ++e) {
               if(  ((electron_potential.at(electron_nearest_electron_list.at(electron).at(e)) < (e_energy - deltaE + DoS_rhs)) \
               && ( (electron_potential.at(electron_nearest_electron_list.at(electron).at(e)) > (e_energy - deltaE -  DoS_lhs) ) ) ) ){
                  DoS1 -= 1;
            ...
            if(d_e_energy + deltaE < transport_cutoff) {
              ...
              for (int i = 1; i < electron_nearest_electron_list.at(electron_collision)[0]; ++i) {
                if( ((electron_potential.at(electron_nearest_electron_list.at(electron_collision).at(i)) < (d_e_energy + deltaE + DoS_rhs)) \
                &&  ( (electron_potential.at(electron_nearest_electron_list.at(electron_collision).at(i)) > (d_e_energy + deltaE -  DoS_lhs) ) ) ) ) {
                  DoS2 -= 1;

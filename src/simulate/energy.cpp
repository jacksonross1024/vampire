...
double spin_applied_field_energy(const double Sx, const double Sy, const double Sz){
	...
	return -sim::actual_H_field*(sim::actual_H_vector[0]*Sx + sim::actual_H_vector[1]*Sy + sim::actual_H_vector[2]*Sz);
...
double spin_magnetostatic_energy(const int atom, const double Sx, const double Sy, const double Sz){
  return 0.0;//-1.0*(dipole::atom_dipolar_field_array_x[atom]*Sx+dipole::atom_dipolar_field_array_y[atom]*Sy+dipole::atom_dipolar_field_array_z[atom]*Sz);

...
//
//   (c) J.L. Ross and Richard Evans 2023. All rights reserved.
//
...
namespace anisotropy{
   ...
   namespace internal{
      ...
      void uniaxial_inplane_second_order_fields(std::vector<double>& spin_array_x,
         ...
         if(!internal::enable_uniaxial_inplane_second_order) return;
         ...
         for(int atom = start_index; atom < end_index; atom++){
            ...
            //needs to be orthogonal to z
            const double ex = 0.0;//internal::ku_para_vector[mat].x;
            const double ey = 1.0;//internal::ku_para_vector[mat].y;
            const double ez = 0.0;//internal::ku_para_vector[mat].z;

            // get reduced anisotropy constant ku/mu_s
            const double ku2 = internal::ku2_para[mat];
      ...
      double uniaxial_inplane_second_order_energy(const int atom,
         ...
         const double ex = internal::ku_para_vector[mat].x;
         const double ey = internal::ku_para_vector[mat].y;
         const double ez = internal::ku_para_vector[mat].z;

...
void build_face_centred_cubic(unitcell::unit_cell_t& unit_cell){
   ...
   unit_cell.atom[1].mat = uc::internal::sublattice_materials ? 0 : 0; // if sublattice material is defined, then identify at as same as ID
   ...
   unit_cell.atom[2].mat = uc::internal::sublattice_materials ? 1 : 0; // if sublattice material is defined, then identify at as same as ID
   ...
   unit_cell.atom[3].mat = uc::internal::sublattice_materials ? 2 : 0; // if sublattice material is defined, then identify at as same as ID   

...
void build_mn3sn(unitcell::unit_cell_t& unit_cell){
   ...
   unit_cell.dimensions[0]=0.5759941877789441;
   unit_cell.dimensions[1]=1.0;
   unit_cell.dimensions[2]=0.4611006474958296;

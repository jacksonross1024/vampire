...
set output "TTMp-debeye-model-1st-der-0.1sink.png"
set title "50nm TiO2; 10nm FGeT"
...
(100.0) w l dt " - " lc "white" notitle

set output "TTMe-debeye-model-1st-der-0.1sink.png"
set xrange [0:time*0.1]
...
set yrange [10:0]
higher_temp(Te, Tp) = Te
set output "TTMe-debeye-model-1st-der-hr-0.1sink.png"
set title "50nm TiO2; 10nm FGeT"
plot for [i=0:h/cell:1] file u ($1*s -o):(i*cell):(s/2.0):(cell/2.0):(higher_temp( column(2+(2*i)), column(3+(2*i)))) w boxxy lc palette notitle,\
(100.0) w l dt " - " lc "white" notitle

set output "FGT-Te-range-0.1sink.png"
set yrange [30:175]
set xrange [-0.25:5]
...
set title "10nm FGT"
set key title "T_e"
plot file u ($1*s-o):2 w l ls 5 title "0 nm",\
"" u ($1*s-o):18 w l ls 4 title "10 nm",\
"" u ($1*s-o):(($2+$4+$6+$8+$10+$12+$14+$16+$18)/9.0) w l ls 2 title "<T_e>"

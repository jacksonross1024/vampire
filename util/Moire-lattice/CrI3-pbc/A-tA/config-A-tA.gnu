...
set title "Layer 2, J"
plot file."-DMI.txt" u ($1*0.693):($2*0.6002):(0.693):(0.6002):($5/$3) w boxxy palette notitle 

set title "Layer 2, D_x"
plot file."-DMI.txt" u ($1*0.693):($2*0.6002):(0.693):(0.6002):($7/$3) w boxxy palette notitle 

set title "Layer 2, D_y"
plot file."-DMI.txt" u ($1*0.693):($2*0.6002):(0.693):(0.6002):($9/$3) w boxxy palette notitle 

set title "Layer 2, D_z"
plot file."-DMI.txt" u ($1*0.693):($2*0.6002):(0.693):(0.6002):($11/$3) w boxxy palette notitle 

set title "Layer 3, J"
plot file."-DMI.txt" u ($1*0.693):($2*0.6002):(0.693):(0.6002):($6/$4) w boxxy palette notitle 

set title "Layer 3, D_x"
plot file."-DMI.txt" u ($1*0.693):($2*0.6002):(0.693):(0.6002):($8/$4) w boxxy palette notitle 

set title "Layer 3, D_y"
plot file."-DMI.txt" u ($1*0.693):($2*0.6002):(0.693):(0.6002):($10/$4) w boxxy palette notitle 

set title "Layer 3, D_z"
plot file."-DMI.txt" u ($1*0.693):($2*0.6002):(0.693):(0.6002):($12/$4) w boxxy palette notitle 
